...
>> Background info is that Elvis's twin was a boy. Probability is 5/11.` 
...
>> Bayesian statistics use prior knowledge to make predictions. For example, taking into account risk factors when determining likelihood of having a heart attack. Frequentist statistics use a number of trials to determine probability of an event. This requires a repeatable process and ideally doesn't include prior knowledge or opinions.
